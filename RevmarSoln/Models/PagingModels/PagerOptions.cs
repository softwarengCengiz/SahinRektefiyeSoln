...
namespace SahinRektefiyeSoln.Models.PagingModels
{
	public class PagerOptions
	{
		public static class DefaultDefaults
		{
			...
			public const string PreviousPageTitle = "Geri";
			public const string NextPageText = "»";
			public const string NextPageTitle = "İleri";
			public const string FirstPageText = "<";
			public const string FirstPageTitle = "İlk Sayfa";
			public const string LastPageText = ">";
			public const string LastPageTitle = "Son Sayfa";
