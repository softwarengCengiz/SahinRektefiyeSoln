			...
			else
			{
				...
				foreach (var paginationLink in model.PaginationLinks)
				{
					if (paginationLink.Active)
					{
						...
						{
							sb.AppendFormat("<span class=\"w3-bar-item w3-green w3-button w3-margin-lr\">{0}</span>", paginationLink.DisplayText);
						}
						...
						else
						{
							...
							linkBuilder.AppendFormat(" href=\"{0}\" title=\"{1}\" class=\"w3-bar-item w3-button w3-hover-light-gray w3-margin-lr\">{2}</a>", paginationLink.Url, paginationLink.DisplayTitle, paginationLink.DisplayText);
					...
					else
					{
						...
						{
							sb.AppendFormat("<span class=\"w3-bar-item w3-margin-lr\">{0}</span>", paginationLink.DisplayText);
						}
						else
						{
							sb.AppendFormat("<span class=\"w3-bar-item w3-margin-lr\">{0}</span>", paginationLink.DisplayText);
